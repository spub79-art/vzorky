        ...
        if(mysqli_stmt_execute($stmt)){
            ...
            if(mysqli_num_rows($result) > 0){
                ...
                while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
                    echo "<li class=\"popis\"> Číslo fólie : </li><li class=\"fid right\">" . $row['fid'] . "</li>";
					echo "<li> Dodavatel : " . $row['dnazev'] . "</li>";
					echo "<li> Název fólie : " . $row['fnazev'] . "</li>";
					echo "<li> Rozměr mm : " . $row['frozmer'] . "</li>";
					echo "<li> Tloušťka &micro;m : " . $row['ftloustka'] . "</li>";
