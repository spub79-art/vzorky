...
if(isset($_POST['produkt'])) { $array[] = "nazev='".$_POST['produkt']."'"; }
...
if($updateField && $_POST['id']) {	
	...
	if($updateField && $_POST['id']) {
		$sqlQuery = "UPDATE produkt SET $updateField WHERE id='" . $_POST['id'] . "'";	
...
if ($_POST['action'] == 'delete' && $_POST['id']) {
	$sqlQuery = "DELETE FROM produkt WHERE id='" . $_POST['id'] . "'";	
	mysqli_query($conn, $sqlQuery) or die("database error:". mysqli_error($conn));	
	$data = array(
